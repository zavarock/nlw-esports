    ...
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="bg-[#2A2334] fixed py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[480px] rounded-lg shadow-lg shadow-black/25">
            ...
            <form className="mt-8 flex flex-col gap-4">
              ...
              <div className="mt-2 flex gap-2 text-sm">
                <input type="checkbox" name="useVoiceChannel" />
